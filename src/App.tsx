...
import { Heart, MapPin, PhoneCall, Shield, Calculator, FlaskConical, ArrowLeft, Globe, User } from 'lucide-react';
...
type Screen = 'disclaimer' | 'landing' | 'dashboard' | 'resources' | 'roa' | 'hotlines' | 'interactions' | 'dose' | 'links' | 'testing' | 'pill-id' | 'laws';
            ...
            <header className="flex justify-between items-center py-4">
              ...
              <div>
                {user ? (
                  <button 
                    onClick={() => logOut()}
                    className="flex items-center gap-2 px-4 py-2 bg-white/10 hover:bg-white/20 rounded-full transition-colors font-bold text-sm uppercase tracking-wider"
                    title="Sign Out"
                  >
                    <img src={user.photoURL || ''} alt="Profile" className="w-6 h-6 rounded-full" onError={(e) => (e.currentTarget.src = 'https://via.placeholder.com/24')} />
                    <span className="hidden sm:inline">Sign Out</span>
                  </button>
                ) : (
                  <button 
                    onClick={() => signInWithGoogle()}
                    className="flex items-center gap-2 px-4 py-2 bg-[#FF1493] hover:bg-[#FF1493]/80 rounded-full transition-colors font-bold text-sm uppercase tracking-wider"
                  >
            ...
            <div className="space-y-12">
              ...
              <section id="tools" className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <button 
                    ...
                    className="col-span-1 flex flex-col items-center justify-center text-center gap-3 p-6 rounded-2xl border border-white/10 bg-white/5 hover:border-[#FF1493]/50 hover:bg-white/10 hover:-translate-y-1 transition-all duration-300 group"
                  >
                  ...
                  <button 
                    onClick={() => setCurrentScreen('pill-id')}
                    className="col-span-1 md:col-span-2 flex flex-col sm:flex-row items-center justify-center text-center gap-4 p-6 rounded-2xl border border-white/10 bg-white/5 hover:border-[#FF1493]/50 hover:bg-white/10 hover:-translate-y-1 transition-all duration-300 group"
                  >
              ...
              <section id="info" className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <button 
                    onClick={() => setCurrentScreen('links')}
                    className="col-span-1 flex flex-col items-center justify-center text-center gap-3 p-6 rounded-2xl border border-white/10 bg-white/5 hover:border-[#FF1493]/50 hover:bg-white/10 hover:-translate-y-1 transition-all duration-300 group"
                  >
                  ...
                  <button 
                    onClick={() => setCurrentScreen('laws')}
                    className="col-span-1 md:col-span-2 flex flex-col items-center justify-center text-center gap-3 p-6 rounded-2xl border border-white/10 bg-gradient-to-br from-blue-500/10 to-blue-500/5 hover:border-blue-500/50 hover:bg-blue-500/10 hover:-translate-y-1 transition-all duration-300 group"
                  >
                    ...
                    <span className="text-xs uppercase text-white/50 font-bold">State-by-State Protections for Overdose Reponses</span>
                  </button>
                </div>
              </section>
              ...
              <section id="local" className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <button 
                    ...
                    className="col-span-1 flex flex-col items-center justify-center text-center gap-3 p-6 rounded-2xl border border-white/10 bg-gradient-to-br from-indigo-500/10 to-purple-500/5 hover:border-indigo-500/50 hover:-translate-y-1 transition-all duration-300 group"
                  >
                  ...
                  <button 
                    ...
                    className="col-span-1 flex flex-col items-center justify-center text-center gap-3 p-6 rounded-2xl border border-white/10 bg-gradient-to-br from-teal-500/10 to-emerald-500/5 hover:border-teal-500/50 hover:-translate-y-1 transition-all duration-300 group"
                  >
          ...
          >
            <header className="p-4 flex items-center gap-4 bg-[#121212] border-b border-white/10 shrink-0">
              <button 
                ...
                className="p-2 hover:bg-white/10 rounded-full transition-all flex items-center justify-center shrink-0"
              >
